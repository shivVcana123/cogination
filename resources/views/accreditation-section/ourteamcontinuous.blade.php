                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header" style="background-color:#0476b4">
                            <h3 class="card-title">{{ empty($ourTeamContinuousSection) || !isset($ourTeamContinuousSection[0]) ? 'Add' : 'Edit' }} Assessment Section Details</h3>
                        </div>
                        <form action="{{ route('save-our-team-continuous-section') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="description">{{ old('description', $ourTeamContinuousSection[0]->description ?? '') }}</textarea>
                                    @error('description')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img id="blah" src="{{asset($ourTeamContinuousSection[0]->image ?? '')}}" alt="Image Preview" style="width: 130px; display:none" />
