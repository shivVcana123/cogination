...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Specialized Certifications Section</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header" style="background-color:#0476b4">
                            <h3 class="card-title">{{ empty($accreditationsSection) || !isset($accreditationsSection[0]) ? 'Add' : 'Edit' }} Specialized Certifications Details</h3>
                        </div>
                        <form action="{{ route('save-specialized-certification-section') }}" method="POST" enctype="multipart/form-data">
                            @csrf
