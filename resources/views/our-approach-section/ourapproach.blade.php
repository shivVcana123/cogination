                        ...
                        <form action="{{ route('save-our-approach-section') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title"
                                            placeholder="Enter first title" value="{{ old('title',$ourApproachSection[0]->title ?? '') }}" required>
                                        @error('title')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <img id="blah" src="{{asset($ourApproachSection[0]->image ?? '')}}" alt="Image Preview" style="width: 130px; display:{{empty($ourApproachSection[0]->image) ? 'none' : 'block'}}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="description" required>{{ old('description', $ourApproachSection[0]->description ?? '') }}</textarea>
                                    @error('description')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <input type="checkbox" id="status" name="status" {{ ($ourApproachSection[0]->status ?? '') === 'on' ? 'checked' : '' }}>
